...
ad_ids_producer2 = list(range(1001, 1021))
user_ids = [
...
# Function to generate a random conversion event for Producer 
def generate_ad_conversion():
    ad_id = random.choice(ad_ids_producer2)
...
while True:
    data = generate_ad_conversion()
    print(data)
    producer_main.produce(topic='ad_conversion', value=data)
    producer_main.flush()
    time.sleep(1)
